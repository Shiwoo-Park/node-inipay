...
var _pay = function(shopData, authResult, successCallback){
    var validationGuide = {
        P_STATUS:"any",
        P_RMESG1:"string",
        P_TID:"string",
    ...
    var exeShopLogic = function (paymentResult){
        ...
        try{
            var shopResult = successCallback(pNoti, paymentResult);
    ...
    inipayUtil.sendPostRequest(authResult.P_REQ_URL, authPostData, function (paymentRes) {
        ...
        paymentRes.on('end', function () {
            ...
            exeShopLogic(pNoti, paymentResult).then(function () {
...
var pay = function(shopData, authData, successCallback, failCallback){
    try{
        return _pay(shopData, authData, successCallback);
    }catch(e){
        failCallback(e);
    }
};
